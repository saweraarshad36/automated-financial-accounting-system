<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Ledger.aspx.cs" Inherits="Pages_Ledger" %>
...
<div class="topnav">
    ...
    <span class="topnav-title">Ledger</span>
    ...
    <div class="filter-card">
        ...
        <div class="filter-body">
            <div class="field">
                ...
                <asp:DropDownList ID="ddlAccountName" runat="server" CssClass="textbox"></asp:DropDownList>
            </div>
            <div class="field">
    ...
    <div class="grid-card">
        ...
        <asp:GridView ID="gvLedger" runat="server" AutoGenerateColumns="false"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="DC"               HeaderText="Dr / Cr" />
                <asp:BoundField DataField="Amount"           HeaderText="Amount"          DataFormatString="{0:N2}" />
                <asp:BoundField DataField="Narration"        HeaderText="Narration" />
                <asp:BoundField DataField="Balance"          HeaderText="Running Balance"  DataFormatString="{0:N2}" />
            </Columns>
        </asp:GridView>
    </div>
