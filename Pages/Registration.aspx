...
.page-wrapper {
    ...
    /* Scrollable left form only */
    overflow: hidden; /* overall wrapper hide overflow */
}
...
.login-container::after {
    ...
    bottom: 60px;
    right: -80px;   /* image side ki taraf */
    z-index: -1;
}
...
<body>
    <script>
        function validateFirstNameSpace(sender, args) {
            args.IsValid = args.Value.indexOf(' ') === -1;
        }

        function validateLastNameSpace(sender, args) {
            args.IsValid = args.Value.indexOf(' ') === -1;
        }
    </script>
...
<div class="page-wrapper">
  ...
  <asp:CustomValidator
    ...
    ClientValidationFunction="validateFirstNameSpace"
    ErrorMessage="Spaces are not allowed. Enter first name only."
    ForeColor="Red"
    Display="Dynamic"
    ValidationGroup="reg">
</asp:CustomValidator>
...
<asp:RegularExpressionValidator
   ...
   <asp:CustomValidator
    ...
    ClientValidationFunction="validateLastNameSpace"
    ErrorMessage="Spaces are not allowed. Enter last name only."
    ForeColor="Red"
    Display="Dynamic"
    ValidationGroup="reg">
</asp:CustomValidator>
...
<asp:RegularExpressionValidator
   ...
   <asp:RegularExpressionValidator
    ...
    ValidationExpression="^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d]+$"
